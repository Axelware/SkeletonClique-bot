...
class Time(commands.Cog):
    ...
    async def timezone_reset(self, ctx: context.Context) -> None:
        """
    ...
    async def timezone_private(self, ctx: context.Context) -> None:
        """
    ...
    async def timezone_public(self, ctx: context.Context) -> None:
        """
